...
SECRET_KEY = 'django-insecure-cc#qg7g(a$2#wrt&8!4lue^d6ca96*0cci8ahiha7_y837tgqb'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': ['rest_framework.permissions.AllowAny'],  # pour autoriser tout le monde (en dev)
